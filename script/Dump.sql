...
--
-- Name: v_avantages; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_avantages AS
SELECT ae.id_employe,
       ae.id_avantage,
       ta.nom
FROM (public.avantage_employe ae
    JOIN public.type_avantage ta ON ((ae.id_avantage = ta.id_avantage)));


ALTER TABLE public.v_avantages OWNER TO postgres;
...
FROM ((((public.conge c
  ...
  WHERE (c.date_fin = '-infinity'::timestamp without time zone);
...
2	2	2023-09-15 00:00:00	2023-10-30 00:00:00	Comptable
...
7	3	TOTO	T	1999-01-12 22:22:22	213131231	10
6	1	ppp	p	1999-01-12 22:22:22	sq	30
4	7	Fabi	a	1999-01-12 22:22:22	d	30
9	7	d	d	1999-01-12 22:22:22	d	0
...
COPY public.conge (matricule, date_debut, date_declaration, details, id_type_conge, date_fin) FROM stdin;
FA0000006	2023-10-21 04:46:00	2023-10-22 04:46:00	Fatigue	4	2023-10-21 05:05:41.950702
FA0000006	2023-10-21 04:46:00	2023-10-22 04:46:00	Fatigue	4	2023-10-21 05:05:41.950702
FA0000006	2023-10-21 04:46:00	2023-10-22 04:46:00	Fatigue	4	2023-10-21 05:05:41.950702
FA0000006	2023-10-21 04:46:00	2023-10-22 04:46:00	Fatigue	4	2023-10-21 05:05:41.950702
FA0000006	2023-10-21 04:46:00	2023-10-22 04:46:00	Fatigue	4	2023-10-21 05:05:41.950702
...
FA0000006	2023-10-21 04:46:00	2023-10-22 04:46:00	Fatigue	4	2023-10-21 05:05:41.950702
FA0000006	2023-10-21 04:46:00	2023-10-22 04:46:00	Fatigue	4	2023-10-21 05:05:41.950702
huhu	-infinity	-infinity	T	4	2023-10-21 05:06:22.523746
huhu	2023-10-21 05:06:00	2023-11-05 05:07:00	j	3	-infinity
FA0000006	2023-10-21 05:07:00	2023-10-28 05:07:00	\N	4	-infinity
\.
...
6	2023-10-20	2024-09-20	2	None	4	0
8	2023-10-20	2024-11-20	2	None	5	0
10	2023-10-21	2024-02-21	2	None	6	0
11	2023-10-21	2024-11-21	3	None	7	0
4	2023-10-20	2025-08-20	1	FA0000004	4	10
7	2023-10-21	2025-03-21	1	FA0000005	5	10
2	2023-10-14	2023-10-14	1	FA0000002	2	10
3	2023-10-14	2023-10-14	2	FA0000003	3	10
1	2023-10-14	2023-10-14	1	FA0000001	1	10
5	2023-10-20	2027-01-20	1	FA0000004	4	10
9	2021-10-21	2026-11-21	1	FA0000006	6	10
12	2023-10-22	2023-12-22	3	FA0000008	8	10
13	2023-10-22	2025-12-22	2	None	8	0
\.
...
SELECT pg_catalog.setval('public.avantage_employe_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.candidat_cv_id_candidat_cv_seq1', 8, true);
...
SELECT pg_catalog.setval('public.candidature_id_candidature_seq1', 9, true);
...
SELECT pg_catalog.setval('public.details_contrat_id_details_contrat_seq1', 13, true);
...
SELECT pg_catalog.setval('public.employe_id_employe_seq1', 8, true);
...
SELECT pg_catalog.setval('public.horaire_id_seq', 69, true);
